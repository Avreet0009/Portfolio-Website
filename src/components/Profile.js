...
const Profile = () => {
  return (
    <div className="max-w-3xl mx-auto mt-16 p-8 bg-none flex flex-col md:flex-row items-center md:items-start gap-12 text-center font-poppins">
        ...
        <div className="flex flex-col text-center justify-center">
            ...
            <div className="mt-3 space-y-1">
                <p className="text-sm text-gray-600 dark:text-gray-400">
                    <a>📧 </a><a href="https://mail.google.com/mail/u/0/#inbox?compose=CllgCJvmZqXDFFnHWdStNbzdjLtGhnKVZQpLDTMDxNhXvTrPtPhxmdCMNlwQDhnDlGZQNqCbZlq" className="hover:underline">avreetsingh0009@gmail.com</a></p>
