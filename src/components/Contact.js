...
const ContactForm = () => {
    return (
        <div className="min-w-80 max-w-lg flex-row mx-auto mt-6 bg-[#7a766f] dark:bg-[#7a766f] p-8 rounded-xl shadow-md">
        <h2 className="text-3xl font-bold mb-4 text-center text-gray-800">Contact Me</h2>
        <form
