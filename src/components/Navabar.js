  ...
  return ( 
    <nav className="bg-[#7a766f] dark:bg-[#333] fixed w-full top-0 z-50 px-12 py-6 flex justify-around items-center">
      <div className="flex font-bold text-[26px]">
        <a href="#profile" className="text-2xl font-bold text-wheat hover:text-black transition-all duration-300">PORTFOLIO</a>
      </div>
      {/* Desktop menu */}
      ...
      {/* <div className="flex md:flex items-center">
        <ul className="flex gap-6 font-bold">
          ...
          <li>
            <a href="#experience" className="text-black hover:text-wheat px-3 py-2 rounded-full transition-colors duration-300">EXPERIENCE</a>
          </li>
          <li>
